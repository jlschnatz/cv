...
print_circle_image(.path = here("img/potrait_image.jpeg"), .bw = TRUE)
```
...
-   **Open Science**: Reproducible Analysis Pipelines and Reports, Data Management, FAIR data
-   **Methods**: Measurement and Psychometrics
-   **Clinical Psychology**: Transdiagnostic Psychopathology
